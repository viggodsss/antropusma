...
<div class="py-6 sm:py-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
    ...
    <div class="reveal mb-6">
        <div class="rounded-2xl border border-emerald-200 bg-emerald-50 p-4 sm:p-5">
    ...
    <div class="reveal mb-8">
        <div class="rounded-2xl overflow-hidden card-lift" style="background: linear-gradient(135deg, #10b981 0%, #059669 50%, #047857 100%);">
            <div class="px-5 sm:px-8 py-5 sm:py-7 text-white">
                <h3 class="text-xl sm:text-2xl md:text-3xl font-extrabold tracking-tight">
                    Halo, {{ $user->name }}! 👋
                </h3>
                <p class="mt-2 text-green-100 text-sm font-medium">Role: <span class="font-bold text-white">{{ ucfirst($user->role) }}</span></p>
            </div>
        </div>
    </div>
    ...
    <div class="reveal mb-6">
        <div class="rounded-2xl border border-amber-200 bg-gradient-to-r from-amber-50 to-yellow-50 p-4 sm:p-5">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-amber-700 mt-1">Resep Anda sudah dibuat oleh petugas/dokter. Nomor antrian farmasi Anda: <span class="font-extrabold">{{ $pharmacyQueue->queue_number }}</span>.</p>
                    </div>
                </div>
    ...
    <!-- Info Cards -->
    <div class="reveal grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-5 mb-6 sm:mb-10">
        <!-- Card 1: Antrian Anda -->
        <div class="card-lift bg-white rounded-2xl border border-green-100 p-6">
            <div class="flex items-center gap-4">
                <div class="flex items-center justify-center h-12 w-12 rounded-xl" style="background: linear-gradient(135deg, #10b981, #059669);">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ $activeQueue->queue_number ?? '-' }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="card-lift bg-white rounded-2xl border border-green-100 p-6">
            <div class="flex items-center gap-4">
                <div class="flex items-center justify-center h-12 w-12 rounded-xl" style="background: linear-gradient(135deg, #34d399, #10b981);">
                    <svg class="h-6 w-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="card-lift bg-white rounded-2xl border border-green-100 p-6">
            <div class="flex items-center gap-4">
                <div class="flex items-center justify-center h-12 w-12 rounded-xl" style="background: linear-gradient(135deg, #6ee7b7, #34d399);">
                    <svg class="h-6 w-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
                </div>
    ...
    <div class="reveal mb-10">
        <div class="bg-white rounded-2xl border border-green-100 overflow-hidden">
            <div class="px-5 sm:px-8 py-5 border-b border-green-100" style="background: linear-gradient(135deg, #059669, #059669);">
    ...
    <div class="reveal">
        <div class="bg-white rounded-2xl border border-green-100 overflow-hidden">
            <div class="px-5 sm:px-8 py-5 border-b border-green-100" style="background: linear-gradient(135deg, #ecfdf5, #d1fae5);">
                <h3 class="text-base sm:text-lg font-bold text-gray-900">⚡ Menu Pasien</h3>
            </div>
            <div class="px-4 sm:px-6 py-4 sm:py-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <a href="{{ route('patient.display') }}" class="card-lift p-5 text-left border border-green-100 rounded-2xl hover:border-green-300 transition group" style="background: #fdfdfd;">
                        <div class="flex items-start gap-4">
                            <div class="w-11 h-11 rounded-xl flex items-center justify-center text-white" style="background: linear-gradient(135deg, #0ea5e9, #0284c7);">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5h18M3 12h18M3 19h18"/>
                                </svg>
                            </div>
                            <div>
                                <h4 class="font-bold text-gray-900 group-hover:text-sky-700">Display Antrian</h4>
                                <p class="text-sm text-gray-500 mt-1">Lihat nomor antrian aktif dan jumlah antrian pada tiap klaster</p>
                            </div>
                        </div>
                    </a>
