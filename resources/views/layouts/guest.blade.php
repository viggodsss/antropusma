...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 antialiased">
        ...
        <div class="min-h-screen flex flex-col justify-start sm:justify-center items-center px-3 sm:px-4 pt-4 pb-6 sm:py-0 relative"
             style="background: url('{{ asset('images/bglogin.png') }}') center/cover no-repeat fixed;">
            {{-- Overlay gradient --}}
            ...
            <div class="relative z-10 flex flex-col items-center w-full max-w-md">
                ...
                <div class="w-full bg-white/95 backdrop-blur-md shadow-2xl rounded-2xl p-4 sm:p-6 border border-white/30">
                    @isset($slot)
                        {{ $slot }}
                    @else
                        @yield('content')
