...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Manrope:wght@600;700;800&family=Plus+Jakarta+Sans:wght@300;400;500;600;700;800&display=swap" rel="stylesheet" />
        ...
        <style>
            ...
            :root {
                ...
                --health-border: rgba(141, 201, 181, 0.28);
                --health-border-strong: rgba(62, 150, 124, 0.22);
                --health-text: #153c36;
                --health-muted: #5e7d76;
                --health-primary: #158f77;
                --health-primary-deep: #0f6b5a;
                --health-primary-soft: #dff5ee;
                --health-accent: #3c9fc4;
                --health-accent-soft: #e1f3fb;
                --health-warning-soft: #fff2d8;
                --health-shadow: 0 20px 60px rgba(21, 60, 54, 0.08);
                --health-shadow-hover: 0 28px 70px rgba(21, 60, 54, 0.12);
            }
            ...
            body.health-theme {
                ...
                background:
                    radial-gradient(circle at top left, rgba(101, 195, 166, 0.22), transparent 34%),
                    radial-gradient(circle at top right, rgba(60, 159, 196, 0.16), transparent 28%),
                    linear-gradient(180deg, #f7fcfa 0%, #eef8f4 46%, #f7fbfd 100%);
                background-attachment: fixed;
            }

            body.health-theme::before {
                content: '';
                position: fixed;
                inset: 0;
                pointer-events: none;
                background-image:
                    linear-gradient(rgba(21, 143, 119, 0.035) 1px, transparent 1px),
                    linear-gradient(90deg, rgba(21, 143, 119, 0.035) 1px, transparent 1px);
                background-size: 32px 32px;
                mask-image: linear-gradient(180deg, rgba(0, 0, 0, 0.55), transparent 85%);
                z-index: -1;
            }

            body.health-theme h1,
            body.health-theme h2,
            body.health-theme h3,
            body.health-theme h4,
            body.health-theme .admin-page-title,
            body.health-theme .brand-name,
            body.health-theme .sidebar-label {
                font-family: 'Manrope', 'Plus Jakarta Sans', sans-serif;
            }

            .health-navbar {
                border-bottom-color: rgba(141, 201, 181, 0.28) !important;
                background: rgba(255, 255, 255, 0.76) !important;
                box-shadow: 0 16px 50px rgba(21, 60, 54, 0.08);
            }

            .health-navbar.shadow-md {
            ...
            .page-content-full::before {
                ...
                border-radius: 32px;
                background:
                    linear-gradient(135deg, rgba(223, 245, 238, 0.95), rgba(225, 243, 251, 0.7)),
                    linear-gradient(180deg, rgba(255, 255, 255, 0.72), rgba(255, 255, 255, 0.3));
                border: 1px solid rgba(141, 201, 181, 0.2);
            ...
            .top-pill-nav {
                ...
                border: 1px solid rgba(141, 201, 181, 0.22);
                color: var(--health-text);
                box-shadow: 0 8px 24px rgba(21, 60, 54, 0.05);
            }

            .top-pill-nav:hover {
                background: rgba(223, 245, 238, 0.92);
                color: var(--health-primary-deep);
                border-color: rgba(21, 143, 119, 0.2);
                box-shadow: 0 14px 30px rgba(21, 60, 54, 0.08);
            }

            .top-pill-center {
                background: linear-gradient(135deg, #eefbf5, #def3ee);
                color: var(--health-primary);
                box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.8);
            }

            .top-pill-active {
                background: linear-gradient(135deg, #158f77, #3c9fc4);
                border-color: transparent;
                box-shadow: 0 18px 38px rgba(21, 143, 119, 0.28);
            }

            .top-pill-active:hover {
                background: linear-gradient(135deg, #0f6b5a, #327fa0);
            }

            .mobile-nav-link {
                background: rgba(255, 255, 255, 0.78);
                border: 1px solid rgba(141, 201, 181, 0.18);
            }

            .mobile-nav-link:hover {
                background: #f2fbf7;
                border-color: rgba(21, 143, 119, 0.18);
            }

            .mobile-nav-active {
                background: linear-gradient(135deg, #edf9f5, #e6f4fb) !important;
                border-color: rgba(21, 143, 119, 0.22);
                box-shadow: 0 14px 30px rgba(21, 60, 54, 0.08);
            }
            ...
            .sidebar-toggle-btn {
                background: linear-gradient(135deg, #eefbf5, #def3ee);
                border-color: rgba(141, 201, 181, 0.3);
                color: var(--health-primary);
            }

            .admin-sidebar {
                background:
                    linear-gradient(180deg, rgba(255, 255, 255, 0.97) 0%, rgba(239, 250, 246, 0.96) 100%);
                border-right: 1px solid rgba(141, 201, 181, 0.28);
                box-shadow: 16px 0 44px rgba(21, 60, 54, 0.08);
            }
            ...
            .sidebar-link:hover {
                background: linear-gradient(135deg, rgba(223, 245, 238, 0.9), rgba(225, 243, 251, 0.85));
            ...
            .sidebar-link-active {
                ...
                color: #ffffff;
                border-left-color: transparent;
                box-shadow: 0 16px 30px rgba(21, 143, 119, 0.24);
            }
            ...
            .sidebar-link .sidebar-icon {
                background: rgba(223, 245, 238, 0.9);
                box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.8);
            }
            ...
            .admin-page-header {
                ...
                padding: 24px 28px;
                border-radius: 28px;
                border: 1px solid rgba(141, 201, 181, 0.26);
                background:
                    radial-gradient(circle at top right, rgba(60, 159, 196, 0.14), transparent 34%),
                    linear-gradient(135deg, rgba(255, 255, 255, 0.95), rgba(241, 250, 247, 0.92));
            ...
            .admin-card,
            .admin-stat-card {
                background: linear-gradient(180deg, rgba(255, 255, 255, 0.96), rgba(251, 255, 253, 0.94));
                border: 1px solid rgba(141, 201, 181, 0.22);
                border-radius: 24px;
                box-shadow: var(--health-shadow);
            ...
            .admin-card:hover,
            .admin-stat-card:hover {
                box-shadow: var(--health-shadow-hover);
                border-color: rgba(21, 143, 119, 0.22);
                transform: translateY(-4px);
            }
            ...
            .admin-card-header {
                padding: 22px 24px;
                border-bottom: 1px solid rgba(141, 201, 181, 0.16);
            }
            ...
            .admin-card-header-icon,
            .admin-stat-icon {
                box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.72), 0 12px 24px rgba(21, 60, 54, 0.08);
            }
            ...
            .admin-table thead th {
                background: linear-gradient(180deg, rgba(241, 250, 247, 0.88), rgba(233, 246, 242, 0.7));
                color: #4b6d66;
                border-bottom-color: rgba(141, 201, 181, 0.22);
            }

            .admin-table tbody td {
                color: #2d4a44;
                border-bottom-color: rgba(141, 201, 181, 0.14);
            }

            .admin-table tbody tr:hover {
                background: rgba(223, 245, 238, 0.36);
            }
            ...
            .badge-info {
                background: rgba(225, 243, 251, 0.92);
                color: #1f6f8d;
                border-color: rgba(60, 159, 196, 0.16);
            }

            .badge-warning {
                background: rgba(255, 242, 216, 0.95);
                color: #a46b0a;
            ...
            .admin-btn {
                border-radius: 14px;
                padding: 10px 18px;
                box-shadow: 0 10px 20px rgba(21, 60, 54, 0.08);
            }
            ...
            .btn-primary:hover {
                box-shadow: 0 16px 28px rgba(21, 143, 119, 0.24);
            }

            .btn-info {
                background: linear-gradient(135deg, #2d93b8, #3c9fc4);
            }
            ...
            .btn-warning {
                background: linear-gradient(135deg, #d9a441, #f0b44d);
            }
            ...
            .admin-search:focus,
            .admin-input:focus {
                border-color: rgba(21, 143, 119, 0.42);
                box-shadow: 0 0 0 4px rgba(21, 143, 119, 0.1);
            }

            .admin-alert {
                border-radius: 18px;
                box-shadow: 0 12px 26px rgba(21, 60, 54, 0.06);
            }

            .alert-success {
                background: linear-gradient(135deg, rgba(223, 245, 238, 0.98), rgba(236, 250, 245, 0.96));
                color: var(--health-primary-deep);
                border-color: rgba(21, 143, 119, 0.16);
            }

            .alert-info {
                background: linear-gradient(135deg, rgba(225, 243, 251, 0.98), rgba(237, 248, 253, 0.96));
                color: #1f6f8d;
                border-color: rgba(60, 159, 196, 0.16);
            }

            .alert-error {
                background: linear-gradient(135deg, rgba(254, 226, 226, 0.98), rgba(255, 241, 241, 0.96));
                color: #9f2e2e;
                border-color: rgba(239, 68, 68, 0.14);
            }

            .card-lift:hover {
                box-shadow: 0 24px 48px rgba(21, 143, 119, 0.12);
            }

            .site-footer {
                background: linear-gradient(180deg, #102824 0%, #0b1f1c 100%) !important;
                border-top: 1px solid rgba(141, 201, 181, 0.12);
            }
    ...
    <body class="health-theme font-sans text-gray-800 antialiased min-h-screen">
    ...
    <nav x-data="{ scrolled: false, mobileOpen: false }"
         ...
         class="health-navbar fixed top-0 inset-x-0 z-40 nav-blur border-b border-green-100 transition-all duration-300">
    ...
    <aside id="adminSidebar" class="admin-sidebar">
        ...
        <div class="py-3">
            ...
            <a href="{{ route('admin.dashboard', ['section' => 'dashboard']) }}" class="sidebar-link {{ request()->routeIs('admin.dashboard') && in_array(request('section', 'dashboard'), ['dashboard', 'statistik-ringkas', 'klaster-keluhan', 'akun-pasien', 'persetujuan-antrian', 'menunggu-scan', 'ringkasan-antrian'], true) ? 'sidebar-link-active' : '' }}">
            ...
            <a href="{{ route('admin.dashboard', ['section' => 'laporan-antrian']) }}" onclick="toggleSidebar()" class="sidebar-link {{ request('section', 'dashboard') === 'laporan-antrian' ? 'sidebar-link-active' : '' }}">
                <span class="sidebar-icon">
                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 10v6m0 0l-3-3m3 3l3-3M5 20h14a2 2 0 002-2v-2a2 2 0 00-2-2h-3M5 20a2 2 0 01-2-2v-2a2 2 0 012-2h3m0 0V4a2 2 0 012-2h4a2 2 0 012 2v10"/></svg>
                </span>
                <span>Laporan Antrian</span>
            </a>
            <a href="{{ route('admin.dashboard', ['section' => 'dashboard']) }}" onclick="toggleSidebar()" class="sidebar-link {{ in_array(request('section', 'dashboard'), ['dashboard', 'persetujuan-antrian', 'menunggu-scan', 'ringkasan-antrian'], true) ? 'sidebar-link-active' : '' }}">
                <span class="sidebar-icon">
    ...
    <footer class="site-footer bg-gray-950 text-gray-400 pt-16 pb-8">
            ...
            <div class="grid md:grid-cols-4 gap-10 mb-12">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        ...
                        <li><a href="{{ route('admin.settings') }}" class="hover:text-green-400 transition">Pengaturan</a></li>
